...
-------------------------------------------------------------------------------
function villages.find_surface_lvm(pos, minp)
...
function villages.save()
  local file = io.open(minetest.get_worldpath().."/villages.txt", "w")
  if file then
    file:write(minetest.serialize(villages_in_world))
    file:close()
  end
end
-------------------------------------------------------------------------------
...
function villages.load()
  local file = io.open(minetest.get_worldpath().."/villages.txt", "r")
  if file then
...
-------------------------------------------------------------------------------
function villages.getlvm(minp, maxp)
...
-- get LVM of current chunk
-------------------------------------------------------------------------------
function villages.setlvm(vm, data)
  -- Write data
  vm:set_data(data)
