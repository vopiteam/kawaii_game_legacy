...
minetest.register_craftitem("farming_addons:candy_cane", {
	description = S"Candy Cane",
	inventory_image = "farming_addons_candy_cane.png",
	on_use = minetest.item_eat(1),
	groups = {food = 1, wieldview = 2}
})

minetest.register_craft({
	output = "farming_addons:candy_cane 8",
	recipe = {
		{"", "default:apple", ""},
		{"", "default:sugar", ""},
		{"", "default:snowball", ""}
...
minetest.register_craftitem("farming_addons:icecreame", {
	description = S"Icecreame",
	inventory_image = "farming_addons_icecreame.png",
	on_use = minetest.item_eat(4),
	groups = {food = 1, wieldview = 2}
})

minetest.register_craft({
	output = "farming_addons:icecreame 2",
	recipe = {
		{"default:ice","default:sugar","default:ice"},
		{"farming:flour","bucket:bucket_milk","farming:flour"},
		{"","farming:flour",""}
	},
	replacements = {{"bucket:bucket_milk", "bucket:bucket_empty"}}
})

minetest.register_craftitem("farming_addons:heart_cookie", {
	description = S"Valentine Cookies",
	inventory_image = "farming_addons_heart_cookie.png",
	on_use = minetest.item_eat(1),
	groups = {food = 1, wieldview = 2}
})

minetest.register_craft({
	output = "farming_addons:heart_cookie 8",
	recipe = {
		{"", "farming:flour", ""},
