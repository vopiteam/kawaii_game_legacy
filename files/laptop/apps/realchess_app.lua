		...
		formspec_func = function(app, mtos)
			...
			local formspec =
					...
					if data.messageOther then
						formspec = formspec..mtos.theme:get_label('2,9.3', mtos.sysram.current_player.." "..data.messageOther)
					else
						formspec=formspec..
								mtos.theme:get_label('2,0.3', data.playerBlack.." "..(data.messageBlack or ""))..
								mtos.theme:get_label('2,9.3', data.playerWhite.." "..(data.messageWhite or ""))
					end
					return formspec
		end,
