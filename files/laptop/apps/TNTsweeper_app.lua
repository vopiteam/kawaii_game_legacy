...
laptop.register_app("tntsweeper", {
	...
	formspec_func = function(app, mtos)
		...
		formspec = formspec .. "background[11.75,0.5;3.2,1.15;"..mtos.theme.contrast_background..']'..
				mtos.theme:get_label("11.75,0.5", "Fields: "..sweeper.data.open_count.."/"..sweeper.data.open_all, "contrast")..
				mtos.theme:get_label("11.75,1", "Bomb: "..sweeper.data.bomb_count.."/"..sweeper.data.bomb_all, "contrast")..
				mtos.theme:get_button('12,2;2.6,0.8', 'major', 'reset', 'Small')..
				mtos.theme:get_button('12,3;2.6,0.8', 'major', 'reset', 'Small hard')..
				mtos.theme:get_button('12,4;2.6,0.8', 'major', 'reset', 'Midsize')..
				mtos.theme:get_button('12,5;2.6,0.8', 'major', 'reset', 'Midsize hard')..
				mtos.theme:get_button('12,6;2.6,0.8', 'major', 'reset', 'Big')..
				mtos.theme:get_button('12,7;2.6,0.8', 'major', 'reset', 'Big hard')
		if data.mark_mode then
			formspec = formspec .. mtos.theme:get_button('12,9;2.6,0.8', 'minor', 'mark_mode', 'mark', 'change to reveal mode')
		else
			formspec = formspec .. mtos.theme:get_button('12,9;2.6,0.8', 'minor', 'mark_mode', 'reveal', 'change to mark mode')
		end
		return formspec
	end,
