laptop.register_app("launcher_settings", {
	...
	formspec_func = function(app, mtos)
		...
		if current_theme then
			formspec = formspec.."image[7.5,1;8,4.5;"..current_theme.desktop_background.."]"
		end

		formspec = formspec .. mtos.theme:get_button('0,5.2;3,1', 'major', 'theme_apply', 'Apply', 'Apply theme')
