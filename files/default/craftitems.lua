...
local function book_on_use(itemstack, user)
	...
	if owner == player_name then
		formspec = "size[8,8]" ..
			...
			"image_button_exit[7.8,-0.25;0.75,0.75;blank.png;exit;;true;false;blank.png]" ..
			"field[0.5,1;7.5,0;title;" .. Sl("Title:") .. ";" ..
				esc(title) .. "]" ..
			"textarea[0.5,1.5;7.5,7;text;" .. Sl("Contents:") .. ";" ..
				esc(text) .. "]" ..
			"image_button_exit[2.5,7.45;3,0.95;book_save_btn.png;save;;true;false;book_save_btn.png]"
	else
		formspec = "size[8,8]" ..
			"background[0,0;0,0;formspec_backround.png;true]" ..
			"image_button_exit[7.8,-0.25;0.75,0.75;blank.png;exit;;true;false;blank.png]" ..
